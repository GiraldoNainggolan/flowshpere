...
// Tambahkan import ini di bagian atas file app/layout.tsx
import { Toaster } from "sonner";

// Di dalam return function RootLayout, tepat di atas {children}, tambahkan:
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <body>
        <Toaster richColors position="top-right" /> {/* <-- INI KUNCI UTAMANYA */}
        {children}
      </body>
    </html>
  );
    ...
    <div className="flex h-screen bg-surface dark:bg-gray-900 overflow-hidden text-text-primary dark:text-gray-100 font-sans transition-colors duration-300">
      ...
      `}>
        ...
        <div className="p-3 border-t border-border-soft dark:border-gray-800 bg-surface dark:bg-gray-900 mt-auto">
          <div onClick={() => setIsProfileOpen(!isProfileOpen)} className="flex items-center gap-3 px-2 py-2 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors cursor-pointer relative z-50">
