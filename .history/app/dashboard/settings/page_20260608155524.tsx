...
function SettingsContent() {
  ...
  return (
    <div className="max-w-5xl mx-auto w-full animate-in fade-in duration-500 pb-10">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white tracking-tight mb-2 transition-colors duration-300">Settings</h1>
        <p className="text-gray-500 dark:text-gray-400 text-lg transition-colors duration-300">Manage your workspace preferences.</p>
      </div>
              ...
              <button 
                ...
                className={`flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${
                  activeTab === tab.id 
                    ...
                    : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800/60 hover:text-gray-900 dark:hover:text-white border border-transparent"
                }`}
              >
          ...
          <form onSubmit={handleSaveChanges} className="p-6 md:p-8">
            ...
            {activeTab === "profile" && (
              <div className="animate-in fade-in duration-300">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6 transition-colors">Profile Information</h2>
                <div className="flex items-center gap-6 mb-8">
                  <input type="file" ref={fileInputRef} onChange={handlePhotoChange} accept="image/*" className="hidden" />
                  <div className="relative group cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                    <div className="h-24 w-24 rounded-full bg-brand-100 dark:bg-gray-800 flex items-center justify-center text-brand-700 dark:text-brand-400 font-bold text-3xl overflow-hidden ring-4 ring-white dark:ring-gray-900 shadow-md transition-all">
                ...
                <div className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input type="text" value={initials} disabled className="w-full px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/40 text-gray-400 dark:text-gray-500 cursor-not-allowed transition-colors" />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input type="email" value={userEmail} disabled className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/40 text-gray-400 dark:text-gray-500 cursor-not-allowed transition-colors" />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Bio</label>
                    <textarea rows={4} value={localBio} onChange={(e) => setLocalBio(e.target.value)} placeholder="Developer at heart..." className="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500/50 resize-none transition-colors duration-300"></textarea>
                  </div>
                </div>
              </div>
            )}
            ...
            {activeTab === "account" && (
              <div className="animate-in fade-in duration-300">
                ...
                <div className="space-y-6">
                  <div className="p-5 border border-gray-200 dark:border-gray-800 rounded-xl bg-gray-50 dark:bg-gray-950/40 transition-colors duration-300">
                  ...
                  <div className="p-5 border border-gray-200 dark:border-gray-800 rounded-xl flex items-center justify-between transition-colors duration-300">
                    <div>
                    ...
                    <div className="border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden divide-y divide-gray-100 dark:divide-gray-800">
                      <div className="p-4 flex items-center justify-between bg-white dark:bg-gray-900/50">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm font-semibold text-gray-900 dark:text-white">Windows PC - Chrome</p>
                            <p className="text-xs text-gray-500 dark:text-gray-400">Current Session • Active now</p>
                          </div>
                        </div>
                      </div>
                      <div className="p-4 flex items-center justify-between bg-white dark:bg-gray-900/50">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm font-semibold text-gray-900 dark:text-white">Mobile Device - Safari</p>
            ...
            {activeTab === "appearance" && (
              <div className="animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mb-8">
                  ...
                  <div onClick={() => setTheme("dark")} className={`border-2 rounded-xl p-4 cursor-pointer relative transition-all duration-300 ${theme === "dark" ? "border-brand-500 bg-gray-50 dark:bg-gray-950 text-brand-600 dark:text-brand-400 shadow-xs" : "border-gray-200 dark:border-gray-800 bg-gray-100 dark:bg-gray-900/60 text-gray-600 dark:text-gray-400"}`}>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800 flex justify-end transition-colors duration-300">
              <button type="submit" disabled={isSaving} className="px-6 py-2.5 bg-brand-500 hover:bg-brand-600 text-white rounded-lg font-medium transition-all active:scale-[0.98] shadow-sm disabled:opacity-70 flex items-center justify-center gap-2 min-w-35">
                {isSaving ? <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div> : <>Save Settings <Check size={18} /></>}
              </button>
            </div>
