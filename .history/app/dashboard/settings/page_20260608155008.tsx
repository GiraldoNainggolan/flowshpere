              ...
              <div className="animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input type="email" value={userEmail} disabled className="w-full px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/40 text-gray-400 dark:text-gray-500 cursor-not-allowed transition-colors" />
                  </div>
                </div>
              </div>
            )}
