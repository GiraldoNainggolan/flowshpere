                ...
                <div className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      ...
                      <input type="text" value={localName} onChange={(e) => setLocalName(e.target.value)} className="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500/50 transition-colors duration-300" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Display Initials</label>
                      <input type="text" value={initials} disabled className="w-full px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/40 text-gray-400 dark:text-gray-500 cursor-not-allowed transition-colors duration-300" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input type="email" value={userEmail} disabled className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/40 text-gray-400 dark:text-gray-500 cursor-not-allowed transition-colors duration-300" />
                    </div>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Managed secure by your OAuth provider (GitHub/GitLab).</p>
                  </div>
                    ...
                    <div className="border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden divide-y divide-gray-100 dark:divide-gray-800">
                      <div className="p-4 flex items-center justify-between bg-white dark:bg-gray-900/50">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm font-semibold text-gray-900 dark:text-white">Windows PC - Chrome <span className="text-[10px] bg-green-100 dark:bg-green-950/60 text-green-700 dark:text-green-400 px-2 py-0.5 rounded-full ml-2 font-bold">Current</span></p>
                            <p className="text-xs text-gray-500 dark:text-gray-400">Bangkalan, ID • Active now</p>
                          </div>
                        </div>
                      </div>
                    </div>
