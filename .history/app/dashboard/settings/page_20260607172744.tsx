...
// 1. KOMPONEN TOGGLE DI LUAR FUNGSI UTAMA (Mengatasi Error Static Components)
...
export default function SettingsPage() {
  ...
  useEffect(() => {
    // 2. FUNGSI DI DALAM useEffect (Mengatasi Error Immutability)
  ...
  const handleSaveChanges = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      window.dispatchEvent(new Event("theme_updated")); // Memicu sinkronisasi Layout
      setIsSaving(false);
