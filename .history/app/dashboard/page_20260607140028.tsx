        ...
        <Link href="/dashboard/projects/1" className="group flex flex-col p-6 rounded-2xl border border-border-soft bg-surface hover:border-brand-300 hover:shadow-float transition-all duration-300 cursor-pointer">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-border-soft">
            ...
            <div className="flex -space-x-2">
              <div className="w-6 h-6 rounded-full bg-brand-200 border-2 border-surface flex items-center justify-center text-[8px] font-bold">GN</div>
              <div className="w-6 h-6 rounded-full bg-success/30 border-2 border-surface flex items-center justify-center text-[8px] font-bold">AC</div>
            </div>
          </div>
        </Link>
