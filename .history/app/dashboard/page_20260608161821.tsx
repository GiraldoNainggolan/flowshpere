...
export default function DashboardPage() {
  // Langsung ambil waktu device pengguna secara real-time
  const getGreeting = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto w-full animate-in fade-in duration-500">
      ...
      <div className="mb-8">
        {/* Fitur suppressHydrationWarning adalah keajaiban Next.js agar server dan client tidak bentrok soal waktu */}
        <h1 suppressHydrationWarning className="text-display-lg text-gray-900 dark:text-white font-bold tracking-tight mb-2 transition-colors">
          {greeting}
        </h1>
