...
// Cukup import Github dan Gitlab
...
export default function LoginPage() {
  ...
  // (Fungsi handleLogin Email biarkan sebagai dummy sementara)
  ...
  // Fungsi Social Login SUNGGUHAN (Sekarang mendukung gitlab)
