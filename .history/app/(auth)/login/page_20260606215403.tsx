...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Perbaikan TS2322: Gunakan format keyframes untuk animasi kompleks GSAP
      gsap.to(".input-group", {
        keyframes: [
          { x: -8 }, { x: 8 }, { x: -6 }, { x: 6 }, { x: -4 }, { x: 4 }, { x: 0 }
        ],
        duration: 0.4,
        ease: "none"
      });
        ...
        <div className="max-w-md w-full">
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-surface px-4 text-text-muted relative z-10">Or continue with</span>
            </div>
          </div>
