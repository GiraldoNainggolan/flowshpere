export default function DashboardPage() {
  return (
    <div className="max-w-7xl mx-auto w-full">
      ...
      {/* Placeholder untuk bagian proyek selanjutnya */}
      <div className="h-64 rounded-xl border-2 border-dashed border-border-soft flex items-center justify-center">
        <p className="text-text-muted">Proyek Kanban Board akan muncul di sini nanti.</p>
      </div>
    </div>
  );
}