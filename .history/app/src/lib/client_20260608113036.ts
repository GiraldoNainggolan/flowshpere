...
export function createClient() {
  ...
  return createBrowserClient(
    process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://sb_publishable_Hvcqsprw2DO0Mzn8JCC8qQ_f4vryhz7.supabase.co', https://sb_publishable_Hvcqsprw2DO0Mzn8JCC8qQ_f4vryhz7.supabase.co 
